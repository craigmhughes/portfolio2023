            ...
            <article className="my-10 md:my-[200px] max-w-[1200px] mx-auto">
                ...
                <div className="text-lg">
                    <p>
                        ...
                        <Highlight>JavaScript, React, and Next.JS, </Highlight> building features in back-end systems
                        and CLI tools using <Highlight>Java, Python, and TypeScript</Highlight>.
                    </p>
                    <br />
                    <p>
                    ...
                    <p>
                        ...
                        development of my game using <Highlight>C# and Unity</Highlight>. I like to think this mirrors
                        my passion for full-stack development, joining my love of design and programming skills.
                    </p>
                </div>
            </article>
                        ...
                        <li className="mb-10 ms-4">
                            ...
                            <ul className="list-disc ml-10 mt-2 [&>li]:my-8 tracking-tight text-lg">
                                <li>
                                    ...
                                    integrating with our internal UI Libraries and adhering to the company design
                                    system. Introduced custom wrappers to handle library errors and documented the
                                    process. Ensured a minimum of 80% test coverage using{' '}
                                    <Highlight>Cypress.JS</Highlight>.
                                </li>
                                <li>
                                    Part of the team that delivered platform migrations for <strong>Cult Beauty</strong>{' '}
                                    and
                                ...
                                <li>
                                    ...
                                    scripts and modifying our existing <Highlight>Java</Highlight> transformers for
                                    products to expose the necessary data.
                                </li>
                                <li>
                                    Assisted in transitioning responsibilities to my previous team by supporting
                                    features and fixes on internal tools. These tools provided platform redirects and a
                                    front-end interface for our Site Configuration API, automating site setup and
                                    configuration for new clients using <Highlight>Angular</Highlight> and{' '}
                                ...
                                <li>
                                    ...
                                    different environments, identifying unused site configurations, and adding new sites
                                    to shared <Highlight>JSON</Highlight> files distributed across the database, using
